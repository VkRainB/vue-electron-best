        ...
        <div class="settings-panel bg-white p-6 rounded-xl shadow-lg">
          ...
          <el-form :model="uiSettings" label-width="120px" class="settings-form">
            ...
            <el-form-item>
              ...
              <el-button @click="resetUISettings">
                重置
              </el-button>
            </el-form-item>
          </el-form>
          ...
          <el-form :model="securitySettings" label-width="120px" class="settings-form">
            ...
            <el-form-item label="密码策略">
              <el-checkbox-group v-model="securitySettings.passwordPolicy">
                <el-checkbox label="requireUppercase">
                  包含大写字母
                </el-checkbox>
                <el-checkbox label="requireLowercase">
                  包含小写字母
                </el-checkbox>
                <el-checkbox label="requireNumbers">
                  包含数字
                </el-checkbox>
                <el-checkbox label="requireSpecialChars">
                  包含特殊字符
                </el-checkbox>
              </el-checkbox-group>
            </el-form-item>
